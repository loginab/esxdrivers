...
/**                                          
 *  zlib_inflate_workspacesize - return the size of struct inflate_workspace 
 *                                           
 *  Return the size of struct inflate_workspace. 
 *                                           
 *  RETURN VALUE:                                           
 *  This function returns the size of struct inflate_workspace.
 */                                          
/* _VMKLNX_CODECHECK_: zlib_inflate_workspacesize */
...
/**                                          
 *  zlib_inflateInit2 - initialize a z_stream 
 *  @strm: a given zstream 
 *  @windowBits: a given sliding window size 
 *                                           
 *  Initialize a given z_stream. 
 *                                           
 *  RETURN VALUE:                     
 *  Z_OK           (0)
 *  Z_STREAM_ERROR (-2)  
 *                                           
 */                                          
/* _VMKLNX_CODECHECK_: zlib_inflateInit2 */
...
/**                                          
 *  zlib_inflate - uses a state machine to process as much input data and generate as much output data as possible before returning
 *  
 *  @strm: a given zstream
 *  @flush: a flush flag 
 *
 ...
 *  Z_BUF_ERROR     (-5)
 */                                          
/* _VMKLNX_CODECHECK_: zlib_inflate */
...
/**                                          
 *  zlib_inflateEnd - indicate a completion of uncompressing 
 *  @strm: a given zstream
 *                                           
 *  Indicate to the caller uncompressing the input stream is done. 
 *                                           
 *  RETURN VALUES:                     
 *  Z_STREAM_ERROR (-2) if strm is NULL or its state is NULL 
 *  Z_OK (0) Otherwise
 *                                           
 */                                          
/* _VMKLNX_CODECHECK_: zlib_inflateEnd */
