...
/**
 *  hid_dump_device - Dump the contents of a device
 *  @device: device in question
 *
 *  Dump the contents of a device. Also displays the Report
 *  types and the fields inside it
 *
 *  RETURN VALUE:
 *  None
 *
 */
 /* _VMKLNX_CODECHECK_: hid_dump_device */
