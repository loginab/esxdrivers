...
#define SCSI_SENSE_BUFFERSIZE 	96
	...
	struct list_head bhlist;  /* scsi_cmnd for vmklnx bh processing */
   	...
   	/* When not using an SG list, request_buffer contains the address for
         ...
         * memory > 4GB, so adding a new field that contains the MA for the IO
         * region
         */
   	dma_addr_t request_bufferMA;
        ...
        /* All commands allocated by scsi_get_command will allocate
         * enough room immediately following the scsi_cmnd to handle
         * the maximally sized scatterlist for the Scsi_Host.
         */
   	struct scatterlist	*sgArray;
#endif
};
