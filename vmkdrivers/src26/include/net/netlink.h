...
{
   vmk_WarningMessage("nlmsg_multicast");
   // NOT_IMPLEMENTED();
   return 0;
}
...
{
   vmk_WarningMessage("nlmsg_unicast");
   // NOT_IMPLEMENTED();
   return 0;
}
...
{
   vmk_WarningMessage("nlmsg_get_pos");
   // NOT_IMPLEMENTED();
   return 0;
}
...
{
   vmk_WarningMessage("nla_nest_start");
   // NOT_IMPLEMENTED();
   return 0;
}

inline struct sock *netlink_kernel_create(int unit, unsigned int groups,
					  void (*input)(struct sock *sk, int len),
					  struct module *module)
{
   vmk_WarningMessage("netlink_kernel_create");
   // NOT_IMPLEMENTED();
   return 0;
}

/**                                          
 *  netlink_ack - non-operational function
 *  @in_skb: Ignored
 *  @nlh: Ignored
 *  @err: Ignored
 *                                           
 ...
 *
 */                                          
/* _VMKLNX_CODECHECK_: netlink_ack */
inline void netlink_ack(struct sk_buff *in_skb, struct nlmsghdr *nlh, int err)
{
   vmk_WarningMessage("netlink_ack");
   // NOT_IMPLEMENTED();
   return;
}

inline int netlink_register_notifier(struct notifier_block *nb)
{
   vmk_WarningMessage("netlink_register_notifier");
   // NOT_IMPLEMENTED();
   return 0;
}
...
/**                                          
 *  netlink_unregister_notifier - non-operational function
 *  @nb: Ignored
 *                                           
 *  A non-operational function provided to help reduce
 *  kernel ifdefs. It is not supported in this release of ESX.
 ...
 *  0 always
 */                                          
/* _VMKLNX_CODECHECK_: netlink_unregister_notifier */
inline int netlink_unregister_notifier(struct notifier_block *nb)
{
   vmk_WarningMessage("netlink_unregister_notifier");
   // NOT_IMPLEMENTED();
   return 0;
}
 ...
 */
/* _VMKLNX_CODECHECK_: nlmsg_unicast */
static inline int nlmsg_unicast(struct sock *sk, struct sk_buff *skb, u32 pid)
{
	int err;
