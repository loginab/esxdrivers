...
/** 
 * csum_add - Combine two partial 32bit checksums
 * @csum:   32bit unsigned partial csum
 * @addend: 32bit unsigned partial csum
 * 
 * Combines two 32bit partial checksums
 *
 * RETURN VALUE:
 * Returns a 32-bit unsigned combined checksum
 */
/* _VMKLNX_CODECHECK_: csum_add */
...
/** 
 * csum_sub - Combine partial and folded 32bit checksums
 * @csum:   32bit unsigned partial csum
 * @addend: 32bit unsigned partial csum
 * 
 * Combines two 32bit partial checksums after folding the second
 * argument 
 *
 * RETURN VALUE:
 * Returns a 32-bit unsigned combined checksum
 */
/* _VMKLNX_CODECHECK_: csum_sub */
