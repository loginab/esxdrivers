 ...
 *
 *  SYNOPSIS:
 *  #define ata_id_rahead_enabled(id)
 *
 *  RETURN VALUE:
 ...
 *
 *  SYNOPSIS:
 *  #define ata_id_wcache_enabled(id)
 *
 *  RETURN VALUE:
 ...
 *
 *  SYNOPSIS:
 *  #define ata_id_has_flush_ext(id)
 *
 *  RETURN VALUE:
...
/**                                          
 *  is_atapi_taskfile - Check if an ATA taskfile uses an ATAPI protocol  
 *  @tf: taskfile to check
 *                                           
 *  Check if an ATA taskfile is using an ATAPI protocol or something other
 *  than ATAPI.                     
 *                                           
 *  RETURN VALUE:
 *     0 if the taskfile does not use ATAPI.
 *     1 if the taskfile does use ATAPI.
 *                                           
 */                                          
/* _VMKLNX_CODECHECK_: is_atapi_taskfile */
