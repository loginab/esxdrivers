...
/**                                          
 *  kobject_name - Retrieve the name of a kobject     
 *  @kobj: Kernel object to get the name from     
 *                                           
 *  Get the name string associated with a kernel object.                      
 *                                           
 *  RETURN VALUE:                    
 *  Name string associated with the given kernel object.
 *                                           
 */                                          
/* _VMKLNX_CODECHECK_: kobject_name */
 ...
 *                                           
 *  This is a non-operational function provided to help reduce kernel ifdefs. 
 ...
 *
 */                                          
/* _VMKLNX_CODECHECK_: add_uevent_var */
