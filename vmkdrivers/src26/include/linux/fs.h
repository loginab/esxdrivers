...
/**                                          
 *  iminor - Returns the minor number of the device.
 *  @inode: Pointer to the inode structure of the device.
 *                                           
 *  Returns the minor device number of the device specified 
 *  by the inode structure.
 *                                           
 *  RETURN VALUE:
 *  Minor number of the device.
 *                                           
 */                                          
/* _VMKLNX_CODECHECK_: iminor */
