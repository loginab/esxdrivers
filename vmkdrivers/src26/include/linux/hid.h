...
#ifdef CONFIG_HID_DEBUG
/**
 *  dbg_hid - Print a kernel debug message
 ...
 *
 *  ESX Deviation Notes:
 *  CONFIG_HID_DEBUG is not defined in ESX. Hence it is a
 *  non-operational function provided to help reduce
 *  kernel ifdefs. It is not supported in this release of ESX
 *
 *  SYNOPSIS:
 ...
 *
 */
 /* _VMKLNX_CODECHECK_: dbg_hid */
#define dbg_hid(format, arg...) if (hid_debug) \
				printk(KERN_DEBUG "%s: " format ,\
				__FILE__ , ## arg)
/**
 *  dbg_hid_line - Print a kernel message
 *  @format: Format string
 *
 *  A non-operational function provided to help reduce
 *  kernel ifdefs. It is not supported in this release of ESX
 ...
 *
 *  SYNOPSIS:
 *      #define dbg_hid_line(format, arg...)
 *
 *  RETURN VALUE:
 *  None
 *
 */
 /* _VMKLNX_CODECHECK_: dbg_hid_line */
