...
static inline char * strncpy(char * dest, const char * src, vmk_size_t maxlen)
{
...
static inline int strncmp(const char * s1, const char * s2, vmk_size_t maxlen)
{
...
static inline vmk_size_t strnlen(const char * s, vmk_size_t maxlen)
{
...
#if defined(__VMKLNX__)
static inline void * memset(void * dest, int byte, vmk_size_t len)
{
...
static inline void * memcpy(void * dest, const void * src, vmk_size_t len)
{
...
static inline int memcmp(const void * s1, const void * s2, vmk_size_t count)
{
...
#define kstrdup(s, gfp) vmklnx_kstrdup(vmklnx_get_module_heap_id(), s, 0)
#else
