...
/* ------------------------------------------------------------------------ */
/*  */
/*  WARNING:  pex_tgt_adr.v assumes if MSB of hub adr is set then it is an ILLEGAL hub!!!!!  */
/*  */
...
/* #define      PX_MAP_CRB_C2C2         40   // N/A: Not use in either Phantom1 or Phantom2 => use for TIMR */
...
#define UNM_HW_CRB_HUB_AGT_ADR_MN       ((UNM_HW_H0_CH_HUB_ADR << 7) | UNM_HW_MN_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PH       ((UNM_HW_H0_CH_HUB_ADR << 7) | UNM_HW_PH_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_MS       ((UNM_HW_H0_CH_HUB_ADR << 7) | UNM_HW_MS_CRB_AGT_ADR)

#define UNM_HW_CRB_HUB_AGT_ADR_PS       ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_PS_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_SS       ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_SS_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_RPMX3    ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_RPMX3_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_QMS      ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_QMS_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_SQS0     ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_SQGS0_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_SQS1     ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_SQGS1_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_SQS2     ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_SQGS2_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_SQS3     ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_SQGS3_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_C2C0     ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_C2C0_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_C2C1     ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_C2C1_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_RPMX2    ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_RPMX2_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_RPMX4    ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_RPMX4_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_RPMX7    ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_RPMX7_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_RPMX9    ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_RPMX9_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_SMB      ((UNM_HW_H1_CH_HUB_ADR << 7) | UNM_HW_SMB_CRB_AGT_ADR)

#define UNM_HW_CRB_HUB_AGT_ADR_NIU      ((UNM_HW_H2_CH_HUB_ADR << 7) | UNM_HW_NIU_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_I2C0     ((UNM_HW_H2_CH_HUB_ADR << 7) | UNM_HW_I2C0_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_I2C1     ((UNM_HW_H2_CH_HUB_ADR << 7) | UNM_HW_I2C1_CRB_AGT_ADR)

#define UNM_HW_CRB_HUB_AGT_ADR_SRE      ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_SRE_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_EG       ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_EG_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_RPMX0    ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_RPMX0_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_QMN      ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_QM_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_SQN0     ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_SQG0_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_SQN1     ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_SQG1_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_SQN2     ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_SQG2_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_SQN3     ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_SQG3_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_RPMX1    ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_RPMX1_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_RPMX5    ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_RPMX5_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_RPMX6    ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_RPMX6_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_RPMX8    ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_RPMX8_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_CAS0     ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_CAS0_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_CAS1     ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_CAS1_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_CAS2     ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_CAS2_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_CAS3     ((UNM_HW_H3_CH_HUB_ADR << 7) | UNM_HW_CAS3_CRB_AGT_ADR)

#define UNM_HW_CRB_HUB_AGT_ADR_PGNI     ((UNM_HW_H4_CH_HUB_ADR << 7) | UNM_HW_PEGNI_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGND     ((UNM_HW_H4_CH_HUB_ADR << 7) | UNM_HW_PEGND_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGN0     ((UNM_HW_H4_CH_HUB_ADR << 7) | UNM_HW_PEGN0_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGN1     ((UNM_HW_H4_CH_HUB_ADR << 7) | UNM_HW_PEGN1_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGN2     ((UNM_HW_H4_CH_HUB_ADR << 7) | UNM_HW_PEGN2_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGN3     ((UNM_HW_H4_CH_HUB_ADR << 7) | UNM_HW_PEGN3_CRB_AGT_ADR)
#define	UNM_HW_CRB_HUB_AGT_ADR_PGN4	    ((UNM_HW_H4_CH_HUB_ADR << 7) | UNM_HW_PEGN4_CRB_AGT_ADR)

#define UNM_HW_CRB_HUB_AGT_ADR_PGNC     ((UNM_HW_H4_CH_HUB_ADR << 7) | UNM_HW_PEGNC_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGR0     ((UNM_HW_H4_CH_HUB_ADR << 7) | UNM_HW_PEGR0_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGR1     ((UNM_HW_H4_CH_HUB_ADR << 7) | UNM_HW_PEGR1_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGR2     ((UNM_HW_H4_CH_HUB_ADR << 7) | UNM_HW_PEGR2_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGR3     ((UNM_HW_H4_CH_HUB_ADR << 7) | UNM_HW_PEGR3_CRB_AGT_ADR)

#define UNM_HW_CRB_HUB_AGT_ADR_PGSI     ((UNM_HW_H5_CH_HUB_ADR << 7) | UNM_HW_PEGSI_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGSD     ((UNM_HW_H5_CH_HUB_ADR << 7) | UNM_HW_PEGSD_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGS0     ((UNM_HW_H5_CH_HUB_ADR << 7) | UNM_HW_PEGS0_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGS1     ((UNM_HW_H5_CH_HUB_ADR << 7) | UNM_HW_PEGS1_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGS2     ((UNM_HW_H5_CH_HUB_ADR << 7) | UNM_HW_PEGS2_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGS3     ((UNM_HW_H5_CH_HUB_ADR << 7) | UNM_HW_PEGS3_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_PGSC     ((UNM_HW_H5_CH_HUB_ADR << 7) | UNM_HW_PEGSC_CRB_AGT_ADR)

#define UNM_HW_CRB_HUB_AGT_ADR_CAM      ((UNM_HW_H6_CH_HUB_ADR << 7) | UNM_HW_NCM_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_TIMR     ((UNM_HW_H6_CH_HUB_ADR << 7) | UNM_HW_TMR_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_XDMA     ((UNM_HW_H6_CH_HUB_ADR << 7) | UNM_HW_XDMA_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_SN       ((UNM_HW_H6_CH_HUB_ADR << 7) | UNM_HW_SN_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_I2Q      ((UNM_HW_H6_CH_HUB_ADR << 7) | UNM_HW_I2Q_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_ROMUSB   ((UNM_HW_H6_CH_HUB_ADR << 7) | UNM_HW_ROMUSB_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_OCM0     ((UNM_HW_H6_CH_HUB_ADR << 7) | UNM_HW_OCM0_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_OCM1     ((UNM_HW_H6_CH_HUB_ADR << 7) | UNM_HW_OCM1_CRB_AGT_ADR)
#define UNM_HW_CRB_HUB_AGT_ADR_LPC      ((UNM_HW_H6_CH_HUB_ADR << 7) | UNM_HW_LPC_CRB_AGT_ADR)
...
#define UNM_PCI_MAPSIZE    128    /* we're mapping 128MB of mem on the PCI bus */
...
typedef enum {
    ...
    UNM_NIU_GB_MII_MGMT_ADDR_PAGE_ADDRESS = 22,
...
typedef union {
    struct {
        unsigned int    enabled: 1,         /* =1 if watchdog is active.
                                             * =0 if watchdog is inactive
                                             * This is read-only for anyone
                                             * but the watchdog itself.
                                             */

                        disable_request: 1, /* Set this to 1 to send disable
                        ...
                        enable_request: 1,  /* Set this to 1 to send enable
                                             * request to watchdog . Watchdog
...
# define UNM_FW_VERSION_BUILD (UNM_CAM_RAM(0x158))
 ...
 */
typedef struct {
    unm_crbword_t dma0:1,       /* 0=DMA0 not masked, 1=masked */
                  dma1:1,       /* 0=DMA1 not masked, 1=masked */
                  i2q:1,        /* 0=I2Q  not masked, 1=masked */
                  dma0_err:1,
                  dma1_err:1,
                  target_status:1,
                  mega_err:1,
...
#define   UNM_QM_DATA(W,P) (UNM_PCI_CAMQM + 0x00010 + (W)*sizeof(unm_dataword_t))
...
/*
 * Command register for getting the QM to do things for you.
 */
typedef struct {
    unm_dataword_t
        op:3,           /* opcode (UNM_QM_CMD_*) */
        hwblock:1,      /* cmd type: 0 for QM, 1 for CAM */
        start:1,        /* 1 to initiate request (PEG, CASP ONLY)*/
        buffnum:1,      /* cmd is in buffer 0 or in buffer 1 */
        side:1,         /* 0=network, 1  = storage  (PEG ONLY) */
        rsvd1:1,
        count:3,        /* Count of 64bit words to xfer */
        rsvd2:20,       /*  */
        ph_side:1,         /* Host only: 0=network, 1 = storage */
        rsvd3:32;
} unm_qm_command_t;

/*
 * Status register once you've asked the QM to do somehing for you.
 */
typedef struct {
    unm_dataword_t
        done:1,        /* 0-not done, 1-done */
        started:1,     /* 1-started, 0-not started */
        error:1,       /* error generated on read */
        timeout:1,     /* timeout on command */
        readempty:1,   /* queue was empty on a read op */
        writefull:1,   /* queue was full on a write op */
        rsvd1:2,
        length:3,      /* num 64bit words (-1) returned */
        rsvd2:21,
        busy:1,
        rsvd3:31;
} unm_qm_status_t;
 ...
 */
typedef enum {
    unm_qm_status_unknown=0, /* error in HW - most likely PCI bug. retry  */
...
unm_qm_result_t unm_qm_request_status(void);
int unm_qm_dequeue_hdr(unm_msg_hdr_t *reqhdr, unm_msg_hdr_t *hdr,
                       unm_msg_body_t *body, int size);
int unm_qm_dequeue_hdr_async(int port, unm_msg_hdr_t *reqhdr);
int unm_qm_read_buffer(int port,
                        unm_msg_hdr_t  *hdr,
                        unm_msg_body_t *body,
                        int            size_bytes);
...
typedef enum {
    ...
    UNM_I2Q_SRC_DMA3       = 13,    /* DMA engine 3 */
    UNM_I2Q_SRC_LPC        = 14,    /*  */
    UNM_I2Q_SRC_SMB        = 15,    /*  */
...
int unm_i2q_int_clear(unm_i2q_source_t source, unm_i2q_ctl_src_t src);
int unm_i2q_control(unm_i2q_source_t source, unm_i2q_ctl_src_t src,
                    unm_i2q_ctl_op_t op, unm_msg_hdr_t *hdr);
...
#define UNM_CRB_READ_CHECK(ADDR, VALUE)                                 \
        do {                                                            \
            if (unm_crb_read(ADDR, VALUE))              return -1;      \
        } while(0)
#define UNM_CRB_WRITE_CHECK(ADDR, VALUE)                                \
        do {                                                            \
            if (unm_crb_write(ADDR, VALUE))             return -1;      \
        } while(0)
...
#define UNM_CRB_WRITELIT_CHECK(ADDR, VALUE)                             \
        do {                                                            \
            if (unm_crb_writelit(ADDR, VALUE))          return -1;      \
        } while(0)
#define UNM_CRB_READ_PANIC(ADDR, VALUE, ERRSTR)                         \
        do {                                                            \
            if (unm_crb_read(ADDR, VALUE))              panic(ERRSTR);  \
        } while(0)
#define UNM_CRB_WRITE_PANIC(ADDR, VALUE, ERRSTR)                        \
        do {                                                            \
            if (unm_crb_write(ADDR, VALUE))             panic(ERRSTR);  \
        } while(0)
#define UNM_CRB_WRITELIT_PANIC(ADDR, VALUE, ERRSTR)                     \
        do {                                                            \
            if (unm_crb_writelit(ADDR, VALUE))          panic(ERRSTR);  \
        } while(0)
#define UNM_IMB_READ_CHECK(ADDR, VALUE)                                 \
        do {                                                            \
            if (unm_imb_read(ADDR, VALUE))              return -1;      \
        } while(0)
#define UNM_IMB_WRITE_CHECK(ADDR, VALUE)                                \
        do {                                                            \
            if (unm_imb_write(ADDR, VALUE))             return -1;      \
        } while(0)
#define UNM_IMB_WRITELIT_CHECK(ADDR, VALUE)                             \
        do {                                                            \
            if (unm_imb_writelit64(ADDR, VALUE))        return -1;      \
        } while(0)
#define UNM_IMB_READ_PANIC(ADDR, VALUE, ERRSTR)                         \
        do {                                                            \
            if (unm_imb_read(ADDR, VALUE))              panic(ERRSTR);  \
        } while(0)
#define UNM_IMB_WRITE_PANIC(ADDR, VALUE, ERRSTR)                        \
        do {                                                            \
            if (unm_imb_write(ADDR, VALUE))             panic(ERRSTR);  \
        } while(0)
#define UNM_IMB_WRITELIT_PANIC(ADDR, VALUE, ERRSTR)                     \
        do {                                                            \
            if (unm_imb_writelit64(ADDR, VALUE))        panic(ERRSTR);  \
        } while(0)
...
#define    UNM_UNICAST_ADDR_BASE           (UNM_CRB_NIU + 0x1080)
...
#define	   UNM_MULTICAST_ADDR_LO_0			(UNM_CRB_NIU + 0x1100)  // BASE ADDRESS FOR POOL/PORT 0
#define	   UNM_MULTICAST_ADDR_LO_1			(UNM_CRB_NIU + 0x1180)  // FOR PORT 1
#define	   UNM_MULTICAST_ADDR_LO_2			(UNM_CRB_NIU + 0x1200)  // FOR PORT 2
#define	   UNM_MULTICAST_ADDR_LO_3			(UNM_CRB_NIU + 0x1280)  // PORT 3
...
/*
    * Time base tick control registers (global and per-flow).
     */
typedef struct {
    unm_crbword_t   count:16,   /* half period of time cycle */
