...
#if defined(CONFIG_IXGBE_VMDQ) && !defined(CONFIG_IXGBE_MQ)
...
#define IXGBE_MAX_VMDQ_INDICES 16
	...
	/* PR 377229 : Restrict VMDQ indices to 8 to avoid NETDEV watchdog issues in > 8 core systems. */
...
#if defined(__VMKLNX__)
#define MAX_TX_QUEUES IXGBE_MAX_VMDQ_INDICES /* OK unless/until using RSS */
#else
...
#if defined(__VMKLNX__)
/* VMware needs ability to turn off VMDQ for Tx and Rx
 * independently of each other.  If VMDQ Tx is turned on then
 * it will use the same number of queues as Rx
 */
#define IXGBE_FLAG_VMDQ_TX_ENABLED              (u32)(1 << 21)
#endif /* defined(__VMKLNX__) */
	/* OS defined structs */
