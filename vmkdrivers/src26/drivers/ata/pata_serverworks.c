...
#define PCI_DEVICE_ID_SERVERWORKS_HT1100IDE 0x0215
...
#if defined(__VMKLNX__)
	{ PCI_DEVICE_ID_SERVERWORKS_HT1100IDE, PCI_ANY_ID, csb_cable },
#endif /* defined(__VMKLNX__) */
	{ }
};
...
#if defined(__VMKLNX__)
		case PCI_DEVICE_ID_SERVERWORKS_HT1100IDE:
#endif /* defined(__VMKLNX__) */
			return 1;
		default:
			break;
...
#if defined(__VMKLNX__)
/**
 *      serverworks_check_atapi_dma - Check whether ATAPI DMA can be supported for this command
 ...
 *               1 otherwise
 */
static int serverworks_check_atapi_dma(struct ata_queued_cmd *qc)
{
	...
	int rc = 1; /* atapi dma off by default */
        ...
        /*
	 * TODO: reddys - maintain blacklist of CD/DVD drives
	 * Vendor: HL-DT-ST Model: DVD-ROM GDR8082N Rev: 0L03
	 * The CD/DVD drives listed are not able todo DMA when used with CSB6IDE
	 * chipset and so for now diasble DMA for non-IO commands.
         * If ATAPI DMA is used for commands not in the
         * following white list driver might hit the irq lost problem.
         */
        switch (scsicmd[0]) {
        case READ_10:
        case WRITE_10:
...
#if defined(__VMKLNX__)
	.check_atapi_dma = serverworks_check_atapi_dma,
#endif /* defined(__VMKLNX__) */
...
static int serverworks_init_one(struct pci_dev *pdev, const struct pci_device_id *id)
{
	...
	/* setup HT1000E */
		 ...
		 (pdev->device == PCI_DEVICE_ID_SERVERWORKS_HT1100IDE))
...
#if defined(__VMKLNX__)
	{ PCI_VDEVICE(SERVERWORKS, PCI_DEVICE_ID_SERVERWORKS_HT1100IDE), 2},
#endif /* defined(__VMKLNX__) */
