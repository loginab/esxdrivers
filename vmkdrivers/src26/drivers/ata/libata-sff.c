...
void ata_bmdma_post_internal_cmd(struct ata_queued_cmd *qc)
{
	...
	/* Don't call bmdma_stop on non DMA capable controllers */
				...
				struct ata_port_info **port, int port_mask)
{
	...
	probe_ent->n_ports = 2;
#if defined(__VMKLNX__)
	/* Legacy ones use ISA irqs, so set the appropriate flag. */
	probe_ent->irq_flags = IRQF_SHARED | SA_VMKISA;
#endif /* defined(__VMKLNX__) */
...
/* Fix the logic to reserve BARs correctly for both legacy/native modes */
#if !defined(__VMKLNX__)
