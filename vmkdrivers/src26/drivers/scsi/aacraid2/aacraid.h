 ...
 */
#define AAC_ROCKET_MAX_QD	(123)

/*
 * The max duration (in secs) that abort handler waits for commands to complete
 * that are still owned by firmware.
 */
#define AAC_MAX_CMD_ABORT_TIMEOUT	(10)
...
#ifdef INITFLAGS_APRE_SUPPORTED
#define ADAPTER_INIT_STRUCT_REVISION_6		6 // apre
#endif
 ...
 * ServeRAID 8k/8k-l8 adapters advertise queue depth of 246, but under heavy load
 * the adpater's firmware gets overloaded and becomes unresponsive.
 * Hence pick conservative queue depth.
 */
#define AAC_QUIRK_REDUCE_QD	0x0040
#endif /* defined(__VMKLNX__) */
...
# ifndef MAX_CODE_STREAM_IDENTIFIER_LENGTH
...
#ifndef INITFLAGS_APRE_SUPPORTED
