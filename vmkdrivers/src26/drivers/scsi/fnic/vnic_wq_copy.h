 ...
 * SOFTWARE.
 */
#ident "$Id: vnic_wq_copy.h 19251 2008-10-08 22:02:17Z ajoglekar $"
	...
	struct fcpio_host_req *wq_desc))
{
	...
	while (1) {
		...
		if (q_service) (*q_service)(wq, &wq_desc[wq->to_clean_index]);
...
int vnic_wq_copy_mem_size(struct vnic_wq_copy *wq, unsigned int desc_count,
