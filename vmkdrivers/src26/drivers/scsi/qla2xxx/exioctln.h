...
#define	EXT_DEF_MAX_LUN_OS		4095	/* 0xFFF */
#define	EXT_DEF_MAX_LUNS		4096	/* 0 - 0xFFF */
#define EXT_DEF_NON_SCSI3_MAX_LUNS	256	/* 0 - 0xFE */
...
#define EXT_CC_RESERVED0L_OS						\
    QL_IOCTL_CMD(0x13)
#define EXT_CC_RESERVED0M_OS						\
    QL_IOCTL_CMD(0x14)
#define EXT_CC_RESERVED0N_OS						\
    QL_IOCTL_CMD(0x15)
#define EXT_CC_RESERVED0O_OS                                            \
    QL_IOCTL_CMD(0x16)
#define EXT_CC_RESERVED0P_OS                                            \
    QL_IOCTL_CMD(0x17)
...
#define EXT_DEF_SUPPORTS_LARGE_LUN	0x0004	/* bit 2: supports large luns upto 4K */
#define EXT_DEF_SUPPORTS_NO_PREF_CHUNKS	0x0008	/* bit 4: driver marks all LUNs
						 * in the chunk as not preferred
						 * if the preferred string is
						 * not present in the conf data
						 * for the perticular chunk
						 */
