...
/*
 * TODO: <divyac> Need to verify if this applies for 2.6
 */
#define MEGA_HAVE_CLUSTERING	0
#else
...
/* TODO: <divyac> for now adding this fixes PR 225478
 * linux 2.6 source doesn't have this, need to check with LSI if they
 * still support this controller
 */
#if defined(__VMKLNX__)
#define PCI_DEVICE_ID_PERC4_DC	        0x0408
#define PCI_DEVICE_ID_PERC4_SE          0x0013
...
#if defined(__VMKLNX__)
/* TODO: <divyac> the adapter fw is reported physical LUNs to the driver,
 * causing vmklinux or storage stack mistakenly adding them to vmkernel.
 * We should only see the logical LUN. PR215909
 */
