...
enum CfgParam_flag {
	CFG_EXPORT = 0x1, /* Export this parameter to the end user */
	CFG_IGNORE = 0x2  /* Ignore this parameter */
};
...
#define FC_REG_LINK_EVENT       	0x1
#define FC_REG_RSCN_EVENT       	0x2
#define FC_REG_CT_EVENT         	0x4
#define FC_REG_DUMP_EVENT       	0x10
#define FC_REG_TEMPERATURE_EVENT	0x20
...
#define LPFC_WRITE_PCI			0x64	/* Write to PCI */
#define LPFC_READ_PCI			0x65	/* Read from PCI */
#define LPFC_READ_MEM			0x66	/* Read memory */
#define LPFC_MBOX			0x67	/* Issue a MB cmd */
#define LPFC_GET_DFC_REV		0x68	/* Get the rev of the ioctl driver */
#define LPFC_WRITE_CTLREG		0x69	/* Write to Control register */
#define LPFC_READ_CTLREG		0x6a	/* Read from Control register */
#define LPFC_INITBRDS			0x6b	/* Initialize the adapters */
#define LPFC_SETDIAG			0x6c	/* Set/get board online/offline */
#define LPFC_GETCFG			0x6d	/* Get config parameters */
#define LPFC_SETCFG			0x6e	/* Set config parameters */
#define LPFC_WRITE_MEM			0x6f	/* Write to SLIM memory */
#define LPFC_GET_VPD			0x70	/* Get Adapter VPD */
#define LPFC_GET_LPFCDFC_INFO		0x71	/* Get lpfcdfc driver info */
#define LPFC_GET_DUMPREGION		0x72	/* Get Adapter Dump Region */
#define LPFC_LOOPBACK_TEST      	0x73    /* Run Loopback test */
#define LPFC_LOOPBACK_MODE      	0x74    /* Enter Loopback mode */
#define LPFC_TEMP_SENSOR_SUPPORT	0x75   /* Get temp sensor support */
#define LPFC_VPORT_GET_ATTRIB		0x76	/* Get vport attibutes */ 
#define LPFC_VPORT_GET_LIST		0x77	/* Get vports on this pport */
#define LPFC_VPORT_GET_RESRC		0x78	/* Get vport resources */
#define LPFC_VPORT_GET_NODE_INFO	0x79	/* Get vport node info by WWPN */
#define LPFC_NPIV_READY			0x7a	/* NPIV Ready Test */
#define LPFC_LINKINFO			0x7b	/* get link information */
#define LPFC_IOINFO  			0x7c	/* get I/O stats */
#define LPFC_NODEINFO  			0x7d	/* get node (NPort) information */
#define LPFC_MENLO			0x7e	/* Issue menlo cmd */
#define LPFC_CT				0x7f	/* Send CT passthru command */
#define LPFC_SEND_ELS			0x80	/* Send out an ELS command */
#define LPFC_HBA_SEND_SCSI		0x81	/* Send SCSI requests to tgt */
#define LPFC_HBA_SEND_FCP		0x82	/* Send out a FCP command */
#define LPFC_HBA_SET_EVENT		0x83	/* Set HBA CT event(s) */
#define LPFC_HBA_GET_EVENT		0x84	/* Get HBA CT event(s) */
#define LPFC_HBA_SEND_MGMT_CMD		0x85	/* Send a management command */
#define LPFC_HBA_SEND_MGMT_RSP		0x86	/* Send a management response */
#define LPFC_LIST_BIND                  0x87    /* Get all nodes */
#define LPFC_VPORT_GETCFG               0x88    /* Get vport config parameters */
#define LPFC_VPORT_SETCFG               0x89    /* Set vport config parameters */
#define LPFC_HBA_UNSET_EVENT		0x8a	/* Unregister for events. */
#define LPFC_PRIMARY_IOCTL_RANGE_END	0x12b	/* End of Primary IOCTL range. */
...
/* Define the driver information structure. */
...
enum lpfc_dfc_drv_info_sliMode {
	...
	FEATURE_LIST      = (FBIT_DIAG | FBIT_NPIV)
};
...
void lpfc_ioctl_rscn_event(struct lpfc_hba *, uint32_t);
