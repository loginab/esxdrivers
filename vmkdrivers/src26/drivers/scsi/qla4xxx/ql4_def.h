...
#define DDB_STATE_MISSING	2	/* Device logged off, trying
					 * to re-login */
#ifdef __VMWARE__
#define DDB_STATE_REMOVED	3	/* Notified vmklinux to remove wait
					 * in this state until vmklinux notifies
					 * us via target_destroy() to free ddb */
#endif
...
#define DF_REMOVE		4	/* Device removed from firmware
					 * now notify vmklinux to remove */
#define DF_FREE			5	/* Device removed from vmklinux
					 * now free via dpc */

#define DF_STOP_RELOGIN		6	/* DDB is in the process of being
...
#ifdef __VMWARE__
#define	AF_OFFLINE_RESET		80 /* 80 secs */
	unsigned int  af_offline;
#endif
...
#define DPC_FREE_DEVICE		     18 /* 0x00040000 */
#endif /* __VMWARE__ */
