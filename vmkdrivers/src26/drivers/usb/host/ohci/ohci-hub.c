...
/**
 *  tick_before - Compare two tick values
 *  @t1: tick value
 *  @t2: tick value
 *
 *  Compare t1 against t2 and return true if t1 is earlier than t2
 *
 *  SYNOPSIS:
 *      #define tick_before(t1, t2)
 *
 *  RETURN VALUE:
 *  TRUE if t1 is earlier than t2, FALSE otherwise
 *
 */
/* _VMKLNX_CODECHECK_: tick_before */
