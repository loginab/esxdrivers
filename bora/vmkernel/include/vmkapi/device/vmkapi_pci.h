 ...
 * \addtogroup Device
 * @{
 * \defgroup PCI PCI-Bus Interfaces
 * @{
 ***********************************************************************
 */
 ...
 *
 * \ingroup PCI
 * \brief Retrieves vmk_PCIDevice handle that corresponds to bus, device
 *        and function
 *
 ...
 ***********************************************************************
 */
VMK_ReturnStatus vmk_PCIGetPCIDevice(const vmk_uint8 bus,
                                     const vmk_uint8 dev,
 ...
 ***********************************************************************
 */
VMK_ReturnStatus vmk_PCIGetBusDevFunc(vmk_PCIDevice device,
                                      vmk_uint8 *bus,
                                      vmk_uint8 *dev,
                                      vmk_uint8 *func);
 ...
 *
 * Fills mapHandle that should be used for the subsequent unmap call.
 *
 * \param[in] device          PCI device handle.
