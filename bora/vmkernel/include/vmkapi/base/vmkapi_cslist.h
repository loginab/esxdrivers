...
vmk_CSListIsEmpty(vmk_CSList *list)
{
   VMK_ASSERT(list);
...
vmk_CSListFirst(vmk_CSList *list)
{
   VMK_ASSERT(list);
...
static inline vmk_SList_Links *
vmk_CSListLast(vmk_CSList *list)
{
   VMK_ASSERT(list);
...
static inline vmk_SList_Links *
vmk_CSListPrev(vmk_CSList *list, vmk_SList_Links *element)
{
   VMK_ASSERT(list);
...
static inline vmk_SList_Links *
vmk_CSListNext(vmk_SList_Links *element)
{
